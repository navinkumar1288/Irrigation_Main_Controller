@echo off
REM Script to completely clean and rebuild project with MQTT v5 support
REM This ensures the ESP-IDF framework is recompiled with CONFIG_MQTT_PROTOCOL_5 enabled
...
REM Step 1: Remove .pio directory (all build artifacts)
...
REM Step 2: Remove platformio cache (optional but recommended)
